...
class WPaginator extends \Twig_Extension
{
     ...
     */
    public function wPaginator(\Twig_Environment $engine, Paginator $posts, int $totalItems, int $pagesCount, int $page)
    {
        $anchors = intdiv($this->numAnchors,2);
        return $engine->render('widgets/w_paginator/w_paginator.html.twig',compact('posts','totalItems','pagesCount','page','anchors'));
    }
